...
<footer class="footer py-4">
	<div class="container">
        ...
        <span style = "padding-left: 35px">Contact Us:</span>
        <br>
        <ul style = "text-align:center;padding-top: 10px">
          <i class="fa fa-phone fa-fw"></i> +91 5673463752
          <br/>
          <i class="fa fa-envelope fa-fw"></i><a href="mailto:hello@siteinfo.com"> hello@siteinfo.com</a>
          <br/>
          <i class="fa fa-map-marker fa-fw"></i> Mumbai, India
        </ul>
        <!--
        <br>
      ...
      <!--<a class="link-dark text-decoration-none me-3" href="javascript:void(0)" id="p_use">Privacy Policy</a>-->
        <span>Developed By: <a href="mailto:oretnom23@gmail.com">xyz</a></span>
			</div>
		</div>
	</div>
</footer>
